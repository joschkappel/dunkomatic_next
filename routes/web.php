...
Route::group([
    ...
    Route::get('contact-us', function ($language) {
        return view('app.contact', ['language' => $language]);
    })->name('contact');
    Route::get('dsgvo', function ($language) {
        return view('app.' . 'de' . '.dsgvo');
    })->name('dsgvo');
    Route::get('faq', function ($language) {
        return view('app.' . 'de' . '.faq', ['region' => session('cur_region'), 'language' => $language, 'user' => Auth::user()]);
    })->name('faq');
    Route::get('release-info', function ($language) {
        return view('app.' . 'de' . '.release_info', ['region' => session('cur_region'), 'language' => $language, 'user' => Auth::user()]);
    })->name('release_info');
