        ...
        <div class="col-md-6">
            ...
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title"><?php echo app('translator')->get('team.title.new', ['club' => $club->shortname]); ?> </h3>
                </div>
                <!-- /.card-header -->
                <form class="form-horizontal" action="<?php echo e(route('club.team.store',['club' => $club]), false); ?>" method="POST">
                    <div class="card-body">
...
unset($__errorArgs, $__bag); ?>' id='selTeamNo' name="team_no">
                                <?php for($i=1; $i<=9; $i++): ?>
                                  <option <?php if($i == old('team_no')): ?> selected <?php endif; ?> value="<?php echo e($i, false); ?>"><?php echo e($i, false); ?></option>
                                <?php endfor; ?>
                                </select>
                            </div>
                        </div>
...
unset($__errorArgs, $__bag); ?>" id="league_prev" name="league_prev" placeholder="<?php echo app('translator')->get('team.league.previous'); ?>" value="<?php echo e(old('league_prev'), false); ?>">
...
unset($__errorArgs, $__bag); ?>" id="shirt_color" name="shirt_color" placeholder="<?php echo app('translator')->get('team.shirtcolor'); ?>" value="<?php echo e(old('shirt_color'), false); ?>">
...
unset($__errorArgs, $__bag); ?>' id='selTday' name="training_day">
                                  <option value="1" <?php if( old('training_day') == '1' ): ?> selected <?php endif; ?>><?php echo e(Carbon\Carbon::now()->startOfWeek(Carbon\Carbon::MONDAY)->locale(Config::get('app.locale'))->dayName, false); ?>

                                  <option value="2" <?php if( old('training_day') == '2' ): ?> selected <?php endif; ?>><?php echo e(Carbon\Carbon::now()->startOfWeek(Carbon\Carbon::TUESDAY)->locale(Config::get('app.locale'))->dayName, false); ?>

                                  <option value="3" <?php if( old('training_day') == '3' ): ?> selected <?php endif; ?>><?php echo e(Carbon\Carbon::now()->startOfWeek(Carbon\Carbon::WEDNESDAY)->locale(Config::get('app.locale'))->dayName, false); ?>

                                  <option value="4" <?php if( old('training_day') == '4' ): ?> selected <?php endif; ?>><?php echo e(Carbon\Carbon::now()->startOfWeek(Carbon\Carbon::THURSDAY)->locale(Config::get('app.locale'))->dayName, false); ?>

                                  <option value="5" <?php if( old('training_day') == '5' ): ?> selected <?php endif; ?>><?php echo e(Carbon\Carbon::now()->startOfWeek(Carbon\Carbon::FRIDAY)->locale(Config::get('app.locale'))->dayName, false); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-sm-3">
                              <div class="input-group date" id="ttime" data-target-input="nearest">
                                <input type="text" class="form-control datetimepicker-input" data-target="#ttime" name="training_time" value="<?php echo e(old('training_time'), false); ?>"/>
...
unset($__errorArgs, $__bag); ?>' id='selGday' name="preferred_game_day">
                                  ...
                                  <option value="6" <?php if( old('preferred_game_day') == '6' ): ?> selected <?php endif; ?>><?php echo e(Carbon\Carbon::now()->startOfWeek(Carbon\Carbon::SATURDAY)->locale(Config::get('app.locale'))->dayName, false); ?>

                                  <option value="7" <?php if( old('preferred_game_day') == '7' ): ?> selected <?php endif; ?>><?php echo e(Carbon\Carbon::now()->startOfWeek(Carbon\Carbon::SUNDAY)->locale(Config::get('app.locale'))->dayName, false); ?>
...
unset($__errorArgs, $__bag); ?>" id="coach_name" name="coach_name" placeholder="<?php echo app('translator')->get('team.coach'); ?>" value="<?php echo e(old('coach_name'), false); ?>">
...
unset($__errorArgs, $__bag); ?>" id="coach_email" name="coach_email" placeholder="<?php echo app('translator')->get('team.email'); ?>" value="<?php echo e(old('coach_email'), false); ?>">
...
unset($__errorArgs, $__bag); ?>" id="coach_phone1" name="coach_phone1" placeholder="<?php echo app('translator')->get('team.phone1'); ?>" value="<?php echo e(old('coach_phone1'), false); ?>">
...
unset($__errorArgs, $__bag); ?>" id="coach_phone2" name="coach_phone2" placeholder="<?php echo app('translator')->get('team.phone2'); ?>" value="<?php echo e(old('coach_phone2'), false); ?>">
...
<?php echo $__env->make('layouts.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/dunkonxt/resources/views/team/team_new.blade.php ENDPATH**/ ?>