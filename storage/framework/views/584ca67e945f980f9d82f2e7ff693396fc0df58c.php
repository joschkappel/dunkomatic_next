    ...
    <div class="modal-dialog modal-side modal-bottom-right modal-notify modal-info" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header bg-danger">
                <p class="heading" id="dheader"><?php echo app('translator')->get('gym.title.delete'); ?>
            ...
            <div class="modal-body">
                <div class="card card-info">
                    ...
                    <form id="confirmDeleteGym" class="form-horizontal" action="" method="POST">
                        ...
                        <div class="card-body">
                            <p class="text-left"><?php echo app('translator')->get('gym.confirm.delete'); ?></p>
...
<?php /**PATH /var/www/dunkonxt/resources/views/club/gym/includes/gym_delete.blade.php ENDPATH**/ ?>