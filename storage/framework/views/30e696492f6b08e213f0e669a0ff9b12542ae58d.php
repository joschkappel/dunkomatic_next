                ...
                <div class="card card-info">
                        <div class="card-body">
                          <div class="form-group row">
                            <label class="col-sm-2 col-form-label" for='selMember'><?php echo e(trans_choice('member.member',1), false); ?></label>
                            <div class="col-sm-6">
...
<?php /**PATH /var/www/dunkonxt/resources/views/member/includes/member_select.blade.php ENDPATH**/ ?>