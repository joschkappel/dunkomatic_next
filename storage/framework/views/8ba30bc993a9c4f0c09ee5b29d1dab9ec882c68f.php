<li <?php if(isset($item['id'])): ?> id="<?php echo e($item['id'], false); ?>" <?php endif; ?>>

    <a class="dropdown-item" href="<?php echo e($item['href'], false); ?>"
...
</li><?php /**PATH /var/www/dunkonxt/resources/views/layouts/partials/navbar/dropdown-item-link.blade.php ENDPATH**/ ?>