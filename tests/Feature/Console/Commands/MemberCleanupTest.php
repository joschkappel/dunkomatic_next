...
it('finds duplicate members by email1,lastname and merges (incl invitations)', function () {
    // Arrange
    $mem_a = Member::factory()->create(['lastname' => 'A', 'email1' => 'A@gmail.com']);
    $mem_b = Member::factory()->create(['lastname' => 'A', 'email1' => 'A@gmail.com']);
    Region::first()->memberships()->create([
    ...
    // add invitation to mem_b
    $invite = Invitation::create(['email_invitee' => $mem_b->email1]);
    User::first()->invitations()->save($invite);
    $mem_b->invitation()->save($invite);
    Region::first()->invitations()->save($invite);
