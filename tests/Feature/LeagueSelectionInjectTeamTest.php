...
class LeagueSelectionInjectTeamTest extends TestCase
{
    ...
    public function create_prerequs()
    {
        ...
        // create league
        static::$league = League::factory()->create(['name' => 'testleague', 'state' => LeagueState::Selection(), 'schedule_id' => $schedule->id]);
        ...
        $this->assertDatabaseHas('leagues', ['id' => static::$league->id, 'state' => LeagueState::Selection()])
    ...
    public function select_leagueteamno()
    {
        ...
        $response = $this->authenticated()
            ->followingRedirects()
            ->post(
                route('league.team.pickchar', ['league' => static::$league->id]), ['league_id' => static::$league->id,
                'league_no' => 1, 'team_id' =>  static::$c_toadd[0]->teams->first()->id ]
            );
