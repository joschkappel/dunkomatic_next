...
class LeagueSizeSchemeController extends Controller
{
    ...
    public function list_piv(LeagueSize $size)
    {
        ...
        return $schemelist
            ...
            ->editColumn('1', function ($d) {
            return $d->{1} == ' ' ? '' : '<span class="badge text-sm badge-pill badge-secondary">1 - '.$d->{1}.'</span>';
            })
            ->editColumn('2', function ($d) {
            return $d->{2} == ' ' ? '' : '<span class="badge text-sm badge-pill badge-primary">2 - '.$d->{2}.'</span>';
            })
            ->editColumn('3', function ($d) {
            return $d->{3} == ' ' ? '' : '<span class="badge text-sm badge-pill badge-secondary">3 - '.$d->{3}.'</span>';
            })
            ->editColumn('4', function ($d) {
            return $d->{4} == ' ' ? '' : '<span class="badge text-sm badge-pill badge-primary">4 - '.$d->{4}.'</span>';
            })
            ->editColumn('5', function ($d) {
            return $d->{5} == ' ' ? '' : '<span class="badge text-sm badge-pill badge-secondary">5 - '.$d->{5}.'</span>';
            })
            ->editColumn('6', function ($d) {
            return $d->{6} == ' ' ? '' : '<span class="badge text-sm badge-pill badge-primary">6 - '.$d->{6}.'</span>';
            })
            ->editColumn('7', function ($d) {
            return $d->{7} == ' ' ? '' : '<span class="badge text-sm badge-pill badge-secondary">7 - '.$d->{7}.'</span>';
            })
            ->editColumn('8', function ($d) {
            return $d->{8} == ' ' ? '' : '<span class="badge text-sm badge-pill badge-primary">8 - '.$d->{8}.'</span>';
            })
            ->editColumn('9', function ($d) {
            return $d->{9} == ' ' ? '' : '<span class="badge text-sm badge-pill badge-secondary">9 - '.$d->{9}.'</span>';
            })
            ->editColumn('10', function ($d) {
            return $d->{10} == ' ' ? '' : '<span class="badge text-sm badge-pill badge-secondary">10 - '.$d->{10}.'</span>';
            })
            ->editColumn('11', function ($d) {
            return $d->{11} == ' ' ? '' : '<span class="badge text-sm badge-pill badge-primary">11 - '.$d->{11}.'</span>';
            })
            ->editColumn('12', function ($d) {
            return $d->{12} == ' ' ? '' : '<span class="badge text-sm badge-pill badge-secondary">12 - '.$d->{12}.'</span>';
            })
            ->editColumn('13', function ($d) {
            return $d->{13} == ' ' ? '' : '<span class="badge text-sm badge-pill badge-primary">13 - '.$d->{13}.'</span>';
            })
            ->editColumn('14', function ($d) {
            return $d->{14} == ' ' ? '' : '<span class="badge text-sm badge-pill badge-secondary">14 - '.$d->{14}.'</span>';
            })
            ->editColumn('15', function ($d) {
            return $d->{15} == ' ' ? '' : '<span class="badge text-sm badge-pill badge-primary">15 - '.$d->{15}.'</span>';
            })
            ->editColumn('16', function ($d) {
            return $d->{16} == ' ' ? '' : '<span class="badge text-sm badge-pill badge-secondary">16 - '.$d->{16}.'</span>';
            })
            ->make(true);
    }
    ...
    public function list_match(LeagueSize $size)
    {
        ...
        foreach ($league_no_a as $no_a) {
            $row = ['league_no' => $no_a->first()->team_home];
