...
return [
  ...
  'reminder.approvals' => 'Da wartet :approvals neuer Benutzer (in :REGION) auf Dein OK.|Da warten :approvals neue Benutzer (in :REGION) auf Dein OK.',
  'reminder.approvals.action' => 'Benutzer jetzt zulassen',
