...
return [
  ...
  'action.size.compare' => 'Wähle die Anzahl der Teams zum Vergleichen',
  ...
  'title.scheme.games' => 'Spielpaarungen :size Schema',
  'title.scheme.matches' => 'Wie ähnlich sind zwei Ziffern des :size Schemas ?',
  'title.scheme.xmatches' => 'Wie ähnlich sind zwei Ziffern des :size1 und :size2 Schemas ?',
  ...
  'title.event.remove' => ':SCHEDULE : Entferne einen oder mehrerer Spieltage',
  'title.event.add' => ':SCHEDULE : Füge einen oder mehrerer fehlende Spieltage ein',
  ...
  'event.remove' => 'Spieltag(e) #gamedayRemoveRange# entfernen ?',
