...
return [
  ...
  'action.size.compare' => 'Please select the number of teams to compare',
  ...
  'title.event.remove' => ':SCHEDULE : Remove one ore more Game Days',
  'title.event.add' => ':SCHEDULE : Add one ore more missing Game Days',
  ...
  'title.scheme.games' => 'Pairings :size Scheme',
  'title.scheme.matches' => 'How close are two numbers of the :size scheme?',
  'title.scheme.xmatches' => 'How close are two numbers of the :size1 and :size2 schemes?',
  ...
  'event.remove' => 'Remove game day(s) #gamedayRemoveRange# ?',
