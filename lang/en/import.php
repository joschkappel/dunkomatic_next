...
return [
    ...
    'referee.uploadhint.1' => 'Support format is .xlsx, .csv (commas as delimiter). You MUST NOT modify content in the ID column!',
    ...
    'league.uploadhint.1' => 'Support format is .xlsx, .csv (commas as delimiter).',
