            ...
            <div class="col-sm-6 pd-2">
                ...
                <div class="card card-outline card-dark " id="clubsCard">
                                ...
                                @for ($i = 1; $i <= $league->size; $i++)
                                    <tr>
                                        ...
                                        @isset($assigned_teams[$i])
                                            ...
                                            <td class="text-dark">{{ $assigned_teams[$i]['shortname'] }}
                                                {{ $assigned_teams[$i]['team_no'] }}</td>
                                        @endisset
                    ...
                    <div class="card-footer">
                        ...
                        @endif
                        <button type="button" class="btn btn-outline-secondary" id="injectTeam" @if ( count($assigned_teams) == $league->size) disabled @endif><i class="fa fa-trash"></i> @lang('game.action.team.add')
                        </button>
                        <button type="button" class="btn btn-outline-secondary" id="withdrawTeam" @if ( count($assigned_teams) == 0) disabled @endif><i class="fa fa-trash"></i> @lang('game.action.team.withdraw')
                        </button>
