                    ...
                    <form class="form-horizontal" action="{{ route('region.update_details', ['region' => $region]) }}"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <select class='js-sel-emailcheck js-states form-control select2' id='selEmailCheck'
                                        name="job_email_valid">
                                        @foreach ($frequencytype as $ft)
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <select class='js-sel-league-reports js-states form-control select2' id='selClubReport'
                                        name="job_club_reports">
                                        @foreach ($frequencytype as $ft)
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <div class="input-group date" id="closeassignment" data-target-input="nearest">
                                        <input type="text" class="form-control datetimepicker-input @error('close_assignment_at') is-invalid @enderror"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <div class="input-group date" id="closeregistration" data-target-input="nearest">
                                        <input type="text" class="form-control datetimepicker-input @error('close_registration_at') is-invalid @enderror" 
                             ...
                             <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <div class="input-group date" id="closeselection" data-target-input="nearest">
                                        <input type="text" class="form-control datetimepicker-input @error('close_selection_at') is-invalid @enderror"
                             ...
                             <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <div class="input-group date" id="closescheduling" data-target-input="nearest">
                                        <input type="text" class="form-control datetimepicker-input @error('close_scheduling_at') is-invalid @enderror"
