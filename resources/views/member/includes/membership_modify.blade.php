<div class="modal fade right" id="modalMembershipMod" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="false" >
    <div class="modal-dialog modal-side modal-bottom-right modal-notify modal-info" role="document">
        <!--Content-->
        <div class="modal-content">
            <!--Header-->
            <div class="modal-header bg-info">
                <p id="modmemrole" class="heading">@lang('title.membership.mod')</p>
                    ...
                    <form id="frmModMembership" class="form-horizontal" action="" method="POST">
                        ...
                        <div class="card-body">
                         <div class="form-group row">
                          ...
                          <div class="col-sm-6">
                              <input type="text" class="form-control @error('function') is-invalid @enderror" id="modmemfunction" name="function" placeholder="@lang('role.function')" value="">
                              @error('function')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control @error('email','err_member') is-invalid @enderror"
                                  id="modmememail" name="email" placeholder="@lang('role.email1')" value="{{ old('email') }}"></input>
                                @error('email')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
