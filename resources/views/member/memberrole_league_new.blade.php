                ...
                <form class="form-horizontal" action="{{ route('league.memberrole.store',['league' => $league]) }}" method="POST">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-2">
                              <input type="text" class="form-control @error('function') is-invalid @enderror" id="function" name="function" placeholder="{{ trans_choice('role.role',1)}}" value="{{ old('function') }}">
                              @error('function')
...
<script>
    $(function() {
      ...
      $(".js-placeholder-single").select2({
          ...
          ajax: {
                  url: "{{ route('league.memberrole.index', ['language'=>app()->getLocale(), 'league' => $league->id]) }}",
                  type: "get",
                  delay: 250,
                  processResults: function (response) {
                    return {
