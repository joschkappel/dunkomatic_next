    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="card card-info">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                  <form id="newMembership" class="form-horizontal" action="{{ route('membership.region.store',['region' => $region]) }}" method="POST">
                        @method('POST')
                        @csrf
                        @if ($errors->any())
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-6">
                            <select class="js-sel-role js-states form-control select2  @error('selRole') is-invalid @enderror"  name="selRole" id='selRole'>
                                <option value="{{ App\Enums\Role::RegionLead() }}" selected="selected">{{App\Enums\Role::RegionLead()->description}}</option>
                            </select>
                            @error('selRole')
